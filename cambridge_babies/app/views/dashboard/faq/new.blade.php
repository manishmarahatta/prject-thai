				...
				<div class="box-body">
						{{ Form::open(array('route'=>'save_faq', 'class'=>'form-horizontal')) }}
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									{{ Form::text('question', '', array('class'=>'form-control', 'placeholder'=>'Enter question', 'required'=>'required"')) }}
								</div>
							</div>
							<div class="form-group">
								{{ Form::label('answer', 'Answer *',array('class'=>'col-sm-2 control-label')) }}
								<div class="col-sm-10">
									{{ Form::textarea('answer','',array('id'=>'editor1','rows'=>'10','cols'=>'80' ,'required'=>'required')) }}
								</div>
							</div>
